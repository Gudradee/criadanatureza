...
from .historico import criar_parcela_default, criar_parcela_recebimento_default
...
def criar():
    ...
    try:
        ...
        criar_parcela_recebimento_default(db, venda)
        ...
        if parceiro_id:
            ...
            if parceiro_obj and parceiro_obj.comissao_percentual > 0:
                ...
                if comissao > 0.001:
                    ...
                    db.add(desp_com)
                    db.flush()
                    criar_parcela_default(db, desp_com)
